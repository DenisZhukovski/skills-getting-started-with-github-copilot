              ...
              <ul class="participants-list" style="list-style-type: none; padding-left: 0;">
                ${details.participants.map(email => `
                  <li style="display: flex; align-items: center; margin-bottom: 2px;">
                    <span>${email}</span>
                    <span class="delete-participant" data-activity="${name}" data-email="${email}" title="Remove participant" style="cursor:pointer; margin-left: 8px; color: #c62828; font-size: 18px;">🗑️</span>
                  </li>
                `).join("")}
              </ul>
            </div>
